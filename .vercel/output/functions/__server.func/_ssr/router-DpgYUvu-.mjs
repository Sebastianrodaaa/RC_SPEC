...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DpgYUvu-.js
...
var styles_default = "/assets/styles-DiiyJVBG.css";
var APP_NAME = "RC Investment · Offering Memorandum";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Urbana @ 39th offering memorandum — generated from the deal folder with sourced figures."
			},
			{
				name: "theme-color",
				content: "#0c0e10"
	...
	component: () => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("html", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("head", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HeadContent, {}) }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("body", {
			className: "font-sans bg-ink text-paper",
			children: [
...
var $$splitComponentImporter = () => import("./routes-DvFxDK_M.mjs");
var Route = createFileRoute("/")({
	validateSearch: (raw) => ({
		export: raw.export === "1" || raw.export === 1 || raw.export === true || raw.export === "true",
		slide: typeof raw.slide === "string" ? raw.slide : void 0
	}),
